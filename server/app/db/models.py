import uuid
from sqlalchemy import Column, Text, Boolean, TIMESTAMP, Float, ForeignKey, Integer, BigInteger, Index
...
class Event(Base):
    ...
    time = Column(TIMESTAMP, nullable=False)  # UTC, from the agent — not created_at
